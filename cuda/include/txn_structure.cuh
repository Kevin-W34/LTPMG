...
#ifndef LTPMG_GPU_TXN_STRUCTURE
#define LTPMG_GPU_TXN_STRUCTURE
...
struct Global_Txn_Aux_Struct {
    ...
    */
    UINT32 data_packet_cur = 0;
    UINT32 bitmap_size;
    UINT32 *bitmap_all_row; // sub_txn_size
    UINT32 *bitmap_used_size; // table_size
    UINT32 *bitmap; // sub_txn_size/device_cnt
    UINT32 *bitmap_tmp; // sub_txn_size/device_cnt
    UINT32 *bitmap_mark; // sub_txn_size
    UINT32 *bitmap_mark_offset; // sub_txn_size
    UINT32 *bitmap_mark_compressed; // sub_txn_size
    // UINT32 *min_TID; // table_size
    UINT32 *cnt_TID; // table_size
    UINT32 *tmp_TID; // table_size
    UINT32 *mark_TID_offset; // table_size
    UINT32 *mark_TID; // sub_txn_size
    UINT32 *merge_tmp;// sub_txn_size
    UINT32 mark_TID_start_offset = 0;
    UINT32 *used_rows;
    UINT32 used_rows_cnt = 0;
};
...
struct Global_Txn_Exec {
    ...
    UINT32 *select_txn_mark; //31~0, 31~5:cur_txn, 4~0:cur_sub_txn
